...
<template>
    ...
    <header v-if="!props.hideCollapse"
        class="sticky top-0 z-40 flex h-14 px-4 items-center rounded-md justify-between my-2.5 mx-2 bg-background/95 backdrop-blur-lg border-b border-border/40 shadow-sm">
