...
const getItemClasses = (itemId: string) => {
  const baseClasses = "w-full flex items-center px-4 py-3 rounded-[16px] text-sm font-light transition-all duration-300 text-left hover:shadow-md";
...
<template>
  <div class="h-full flex flex-col bg-white/70 dark:bg-gray-800/70 backdrop-blur-lg border-r border-white/20 dark:border-gray-700/30">
    <!-- Logo -->
    <div class="p-6 border-b border-white/20 dark:border-gray-700/30">
      <h1 class="text-2xl font-bold text-gray-700 dark:text-gray-200">StudyApp</h1>
    </div>
    ...
    <div class="p-4 border-t border-white/20 dark:border-gray-700/30">
      <div class="flex items-center space-x-3 p-3 rounded-[12px] hover:bg-white/50 dark:hover:bg-gray-700/50 transition-all duration-300 cursor-pointer">
        <div class="w-8 h-8 bg-gradient-to-r from-violet-400 to-purple-500 rounded-full flex items-center justify-center">
          <Icon name="users" class="w-4 h-4 text-white" />
        </div>
        <div class="flex-1">
          <p class="text-sm font-medium text-gray-700 dark:text-gray-200">Profile</p>
        </div>
      </div>
    </div>
  </div>
