      ...
      >
        ...
        >
          ...
          <div @click="handleRedirect(set.id)" class="flex h-full w-full flex-col">
            ...
            <!-- Titre + compteur ------------------------------------------->
            <div class="mt-auto">
              <h3 class="text-left text-xl font-medium text-gray-800 dark:text-gray-100 transition-colors duration-300 group-hover:text-violet-600 dark:group-hover:text-violet-400">
                {{ set.name }}
              </h3>
      ...
      <div class="mt-16 flex justify-center">
        ...
        <AlertDialog v-model:open="isDialogOpen">
          <AlertDialogTrigger as-child>
            <Button
              class="rounded-xl px-6 py-3 text-white text-lg font-medium"
            >
