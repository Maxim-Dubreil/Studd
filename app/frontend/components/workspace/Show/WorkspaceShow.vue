  ...
  <AppLayout :hide-sidebar="true" :hide-top-nav="true" :hide-toggle="false" :hide-gradient="false">
    <section class="flex flex-1 overflow-hidden">
      ...
      <WorkspaceGrid class="lg:grid-rows-4">
        <!-- Col 1 – lignes 1-3 -->
        <WorkspaceCard name="Fiche de révisions" desc="Génère des fiches de révisions à partir des fichiers uploadés"
          href="#" cta="Ouvrir" :Icon="Clipboard" :bg-image="ficheDeRevisionsIcon"
          cls="lg:col-start-1 lg:col-end-2 lg:row-start-1 lg:row-end-4" />

        <!-- Col 2 – lignes 1-4 -->
        <WorkspaceCard name="Quizz et tests" desc="Génère des quizz intelligents qui s’adaptent selon vos erreurs"
          href="#" cta="Ouvrir" :Icon="HelpCircle" :bg-image="quizzIcon"
          cls="lg:col-start-2 lg:col-end-3 lg:row-start-1 lg:row-end-5" />

        <!-- Col 3 – ligne 1 -->
        <WorkspaceCard name="Cartes mentales" desc="Génère des cartes mentales à partir des fichiers uploadés" href="#"
          cta="Ouvrir" :Icon="Calendar" :bg-image="carteMentaleIcon"
          cls="lg:col-start-3 lg:col-end-4 lg:row-start-1 lg:row-end-2" />

        <!-- Col 3 – lignes 2-4 -->
        <WorkspaceCard name="Progression" desc="Consulter votre progression et vos statistiques" href="#" cta="Voir"
          :Icon="LineChart" :bg-image="progressionIcon" cls="lg:col-start-3 lg:col-end-4 lg:row-start-2 lg:row-end-5" />

        <!-- Col 1 – ligne 4 -->
        <WorkspaceCard name="Flash-cards" desc="Génère des flash-cards à partir des fichiers uploadés"
          :href="`${props.workspace.id}/flashcards`" cta="Ouvrir" :Icon="SquareStack" :bg-image="flashcardsIcon"
