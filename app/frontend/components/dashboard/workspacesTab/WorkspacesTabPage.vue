          ...
          <div
            ...
            <div class="flex-1 overflow-y-auto scrollbar-hide p-6">
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                <WorkspaceTabCard v-for="workspace in displayedWorkspaces" :key="workspace.id" :workspace="workspace" />

                <!-- Message si aucun workspace -->
                <div v-if="displayedWorkspaces.length === 0" class="col-span-full text-center py-12">
                  <Icon name="grid" class="w-16 h-16 text-gray-300 dark:text-gray-600 mx-auto mb-4" />
            ...
            <div class="flex-1 p-6 space-y-6">
                ...
                <div class="space-y-2">
                  <Button variant="outline" class="w-full">
                    <div class="flex items-center">
                      ...
                      <span
                        class="ml-3 text-sm text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white">Paramètres</span>
                    </div>
                  </Button>
                  <Button variant="outline" class="w-full">
                    <div class="flex items-center">
                      <Icon name="users"
                        class="w-4 h-4 text-gray-500 dark:text-gray-400 group-hover:text-violet-500 transition-colors" />
                      <span
                        class="ml-3 text-sm text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white">Inviter
                        des membres</span>
                    </div>
                  </Button>
                  <Button variant="outline" class="w-full">
                    <div class="flex items-center">
                      <Icon name="document"
                        class="w-4 h-4 text-gray-500 dark:text-gray-400 group-hover:text-violet-500 transition-colors" />
                      <span
                        class="ml-3 text-sm text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-white">Documentation</span>
                    </div>
                  </Button>
                </div>
              </div>
              ...
              <div class="bg-blue-50/50 dark:bg-blue-900/20 rounded-xl p-4">
                <div class="flex items-start">
                  <Icon name="info" class="w-5 h-5 text-blue-500 dark:text-blue-400 mt-0.5" />
                  <div class="ml-3">
